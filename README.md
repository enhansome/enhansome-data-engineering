...
* Relational
  * [RQLite](https://github.com/rqlite/rqlite) ⭐ 17,734 | 🐛 82 | 🌐 Go | 📅 2026-09-14 - Replicated SQLite using the Raft consensus protocol.
  * [MySQL](https://www.mysql.com/) - The world's most popular open source database.
    * [TiDB](https://github.com/pingcap/tidb) ⭐ 40,528 | 🐛 6,997 | 🌐 Go | 📅 2026-09-14 - A distributed NewSQL database compatible with MySQL protocol.
...
* Column
  * [FiloDB](https://github.com/filodb/FiloDB) ⭐ 1,467 | 🐛 70 | 🌐 Scala | 📅 2026-09-11 - Distributed. Columnar. Versioned. Streaming. SQL.
  * [Cassandra](https://cassandra.apache.org/) - The right choice when you need scalability and high availability without compromising performance.
    * [ScyllaDB](https://github.com/scylladb/scylla) ⭐ 15,754 | 🐛 3,663 | 🌐 C++ | 📅 2026-09-14 - NoSQL data store using the seastar framework, compatible with Apache Cassandra.
...
* Graph
  ...
  * [Omnigraph](https://github.com/ModernRelay/omnigraph) ⭐ 1,111 | 🐛 59 | 🌐 Rust | 📅 2026-09-14 - Typed graph database where agents branch and merge like Git. S3-native, Rust, traversal + vector + BM25 in one runtime.
...
* Timeseries
  * [InfluxDB](https://github.com/influxdata/influxdb) ⭐ 31,740 | 🐛 2,165 | 🌐 Rust | 📅 2026-09-15 - Scalable datastore for metrics, events, and real-time analytics.
  * [Druid](https://github.com/apache/incubator-druid) ⭐ 14,052 | 🐛 797 | 🌐 Java | 📅 2026-09-15 - Column oriented distributed data store ideal for powering interactive applications.
...
* Other
  * [zvec](https://github.com/alibaba/zvec) ⭐ 15,921 | 🐛 57 | 🌐 C++ | 📅 2026-09-14 - An embedded vector database for on-device RAG and edge AI, the SQLite of vector databases.
  * [cayley](https://github.com/cayleygraph/cayley) ⭐ 15,062 | 🐛 93 | 🌐 Go | 📅 2026-08-27 - An open-source graph database. Google.
  * [Manticore Search](https://github.com/manticoresoftware/manticoresearch) ⭐ 12,000 | 🐛 647 | 🌐 C++ | 📅 2026-09-14 - An open-source search database for full-text, vector, and hybrid search with real-time indexing and SQL.
  * [Tarantool](https://github.com/tarantool/tarantool/) ⭐ 3,668 | 🐛 1,725 | 🌐 Lua | 📅 2026-09-14 - An in-memory database and application server.
...
* [datacompy](https://github.com/capitalone/datacompy) ⭐ 657 | 🐛 9 | 🌐 Python | 📅 2026-09-12 - A Python library that facilitates the comparison of two DataFrames in Pandas, Polars, Spark and more. The library goes beyond basic equality checks by providing detailed insights into discrepancies at both row and column levels.
...
* [Kreuzberg](https://github.com/kreuzberg-dev/kreuzberg) ⭐ 9,306 | 🐛 5 | 🌐 Rust | 📅 2026-09-14 - Polyglot document intelligence library with a Rust core and bindings for Python, TypeScript, Go, and more. Extracts text, tables, and metadata from 62+ document formats for data pipeline ingestion.
* [Jitsu](https://github.com/jitsucom/jitsu) ⭐ 5,071 | 🐛 46 | 🌐 TypeScript | 📅 2026-09-14 - An open-source Customer Data Platform. Captures event data from websites, apps, and servers and streams it into ClickHouse, Snowflake, BigQuery, Redshift, Postgres, and MySQL in real time.
* [AWS Data Wrangler](https://github.com/awslabs/aws-data-wrangler) ⭐ 4,120 | 🐛 53 | 🌐 Python | 📅 2026-09-14 - Utility belt to handle data on AWS.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,962 | 🐛 22 | 🌐 Go | 📅 2026-09-14 - CLI tool to copy data between databases with a single command. Supports 50+ sources including PostgreSQL, MySQL, MongoDB, Salesforce, Shopify to any data warehouse.
...
* [Duckle](https://github.com/SouravRoy-ETL/duckle) ⭐ 1,298 | 🐛 58 | 🌐 Rust | 📅 2026-09-11 - Local-first, open-source desktop ETL/ELT studio: drag a pipeline onto a canvas (or describe it to a built-in on-device AI assistant) and run it at native speed through DuckDB. 290+ connectors, a scheduler, and an MCP server for driving pipelines from an LLM. No cloud, no servers.
...
* [drt](https://github.com/drt-hub/drt) ⭐ 32 | 🐛 50 | 🌐 Python | 📅 2026-09-14 - OSS Reverse ETL CLI. Sync data from warehouses to business tools via YAML.
* [Google Sheets ETL](https://github.com/fulldecent/google-sheets-etl) ⭐ 21 | 🐛 3 | 🌐 PHP | 📅 2026-03-02 - Live import all your Google Sheets to your data warehouse.
...
* [faucet-stream](https://github.com/PawanSikawat/faucet-stream) ⭐ 11 | 🐛 51 | 🌐 Rust | 📅 2026-09-01 - Config-driven data-movement platform for Rust with pluggable source and sink connectors, running ETL, CDC, and streaming pipelines declaratively from YAML or embedded as a library.
...
* [Kafka](https://kafka.apache.org/) - Publish-subscribe messaging rethought as a distributed commit log.
  ...
  * [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 1,047 | 🐛 591 | 🌐 C | 📅 2026-09-14 - The Apache Kafka C/C++ library.
  * [kafkat](https://github.com/airbnb/kafkat) ⭐ 502 | 🐛 14 | 🌐 Ruby | 📅 2019-06-01 - Simplified command-line administration for Kafka brokers.
  * [Kroxylicious](https://github.com/kroxylicious/kroxylicious) ⭐ 322 | 🐛 369 | 🌐 Java | 📅 2026-09-14 - A Kafka Proxy, solving problems like encrypting your Kafka data at rest.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 14,423 | 🐛 206 | 🌐 Go | 📅 2026-09-14 - A high-performance Cloud-Native file system driven by object storage for large-scale data storage.
...
* [ProtoBuf](https://github.com/protocolbuffers/protobuf) ⭐ 72,038 | 🐛 349 | 🌐 C++ | 📅 2026-09-15 - Protocol Buffers - Google's data interchange format.
...
* [Apache Parquet](https://parquet.apache.org) - A columnar storage format available to any project in the Hadoop ecosystem, regardless of the choice of data processing framework, data model or programming language.
  * [Snappy](https://github.com/google/snappy) ⭐ 6,612 | 🐛 64 | 🌐 C++ | 📅 2026-09-14 - A fast compressor/decompressor. Used with Parquet.
...
* [Pathway](https://github.com/pathwaycom/pathway) ⭐ 62,286 | 🐛 36 | 🌐 Python | 📅 2026-09-12 - Performant open-source Python ETL framework with Rust runtime, supporting 300+ data sources.
* [CocoIndex](https://github.com/cocoindex-io/cocoindex) ⭐ 11,551 | 🐛 85 | 🌐 Rust | 📅 2026-09-14 - An open source ETL framework to build fresh index for AI.
* [PipelineDB](https://github.com/pipelinedb/pipelinedb) ⭐ 2,663 | 🐛 133 | 🌐 C | 📅 2022-02-20 - The Streaming SQL Database.
* [Robinhood's Faust](https://github.com/faust-streaming/faust) ⭐ 1,888 | 🐛 145 | 🌐 Python | 📅 2026-09-02 - Forever scalable event processing & in-memory durable K/V store as a library with asyncio & static typing.
* [Kuiper](https://github.com/emqx/kuiper) ⭐ 1,735 | 🐛 51 | 🌐 Go | 📅 2026-09-14 - An edge lightweight IoT data analytics/streaming software implemented by Golang, and it can be run at all kinds of resource-constrained edge devices.
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,728 | 🐛 254 | 🌐 Java | 📅 2026-09-14 - - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT, and the native Kafka protocol.
...
* [Apache Superset](https://github.com/apache/incubator-superset) ⭐ 74,760 | 🐛 612 | 🌐 Python | 📅 2026-09-15 - A modern, enterprise-ready business intelligence web application.
* [Metabase](https://github.com/metabase/metabase) ⭐ 49,252 | 🐛 4,350 | 🌐 Clojure | 📅 2026-09-15 - The easy, open source way for everyone in your company to ask questions and learn from data.
* [Plotly](https://github.com/plotly/dash) ⭐ 24,406 | 🐛 479 | 🌐 Python | 📅 2026-09-14 - Flask, JS, and CSS boilerplate for interactive, web-based visualization apps in Python.
* [PyXley](https://github.com/stitchfix/pyxley) ⚠️ Archived - Python helpers for building dashboards using Flask and React.
* [Dekart](https://github.com/dekart-xyz/dekart) ⭐ 417 | 🐛 33 | 🌐 JavaScript | 📅 2026-09-14 - Open-source SQL to map platform for BigQuery, Snowflake, and PostGIS.
...
* [FlexViz](https://github.com/flex-analytics/flexviz) ⭐ 18 | 🐛 21 | 🌐 Python | 📅 2026-09-14 - Open-source Python library for interactive cross-filter dashboards on large datasets. Zoom, pan, and selection are answered by lazy Polars aggregations on a stateless server instead of sending rows to the browser.
...
* [Airflow](https://github.com/apache/airflow) ⭐ 46,856 | 🐛 2,124 | 🌐 Python | 📅 2026-09-15 - A system to programmatically author, schedule, and monitor data pipelines.
* [Kestra](https://github.com/kestra-io/kestra) ⭐ 28,114 | 🐛 689 | 🌐 Java | 📅 2026-09-14 - Scalable, event-driven, language-agnostic orchestration and scheduling platform to manage millions of workflows declaratively in code.
* [Luigi](https://github.com/spotify/luigi) ⭐ 18,773 | 🐛 175 | 🌐 Python | 📅 2026-07-18 - A Python module that helps you build complex pipelines of batch jobs.
* [Dagster](https://github.com/dagster-io/dagster) ⭐ 16,150 | 🐛 2,587 | 🌐 Python | 📅 2026-09-14 - An open-source Python library for building data applications.
* [DataFlow](https://github.com/OpenDCAI/DataFlow) ⭐ 8,183 | 🐛 9 | 🌐 Python | 📅 2026-09-13 - Open-source platform for data preparation, synthetic data generation, and AI/data pipelines. Includes reusable skills for automating workflow steps across data and AI tasks.
* [RudderStack](https://github.com/rudderlabs/rudder-server) ⭐ 4,486 | 🐛 45 | 🌐 Go | 📅 2026-09-14 - A warehouse-first Customer Data Platform that enables you to collect data from every application, website and SaaS platform, and then activate it in your warehouse and business tools.
...
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,706 | 🐛 58 | 🌐 Go | 📅 2026-09-14 - End-to-end data pipeline tool that combines ingestion, transformation (SQL + Python), and data quality in a single CLI. Connects to BigQuery, Snowflake, PostgreSQL, Redshift, and more. Includes VS Code extension with live previews.
* [Multiwoven](https://github.com/Multiwoven/multiwoven) ⭐ 1,673 | 🐛 188 | 🌐 Ruby | 📅 2026-09-15 - The open-source reverse ETL, data activation platform for modern data teams.
...
* [OrionBelt Semantic Layer](https://github.com/ralfbecher/orionbelt-semantic-layer) ⭐ 79 | 🐛 4 | 🌐 Python | 📅 2026-09-14 - Open-source semantic sidecar that compiles YAML-defined dimensions, measures, and metrics into optimized SQL across 8 engines (BigQuery, ClickHouse, Databricks, Dremio, DuckDB, MySQL, PostgreSQL, Snowflake). Unified REST, MCP, and Postgres wire protocol; one model powers AI agents, analytics, DQ rules, and KPIs.
* [Nika](https://github.com/supernovae-st/nika) ⭐ 78 | 🐛 90 | 🌐 Rust | 📅 2026-09-14 - Intent-as-code workflow engine for AI data pipelines: reviewable YAML DAGs statically checked (schema, permits, cost floor) before execution, with tamper-evident run traces.
* [PACE](https://github.com/getstrm/pace) ⭐ 40 | 🐛 16 | 🌐 Kotlin | 📅 2026-09-14 - An open source framework that allows you to enforce agreements on how data should be accessed, used, and transformed, regardless of the data platform (Snowflake, BigQuery, DataBricks, etc.)
...
* [lakeFS](https://github.com/treeverse/lakeFS) ⭐ 5,525 | 🐛 441 | 🌐 Go | 📅 2026-08-19 - An open source platform that delivers resilience and manageability to object-storage based data lakes.
* [Gravitino](https://github.com/apache/gravitino) ⭐ 3,220 | 🐛 1,071 | 🌐 Java | 📅 2026-09-14 - An open-source, unified metadata management for data lakes, data warehouses, and external catalogs.
* [Project Nessie](https://github.com/projectnessie/nessie) ⭐ 1,510 | 🐛 164 | 🌐 Java | 📅 2026-09-15 - A Transactional Catalog for Data Lakes with Git-like semantics. Works with Apache Iceberg tables.
...
* [Nomad](https://github.com/hashicorp/nomad) ⭐ 16,932 | 🐛 1,624 | 🌐 Go | 📅 2026-09-14 - A cluster manager, designed for both long-lived services and short-lived batch processing workloads.
...
* [Prometheus.io](https://github.com/prometheus/prometheus) ⭐ 66,074 | 🐛 882 | 🌐 Go | 📅 2026-09-14 - An open-source service monitoring system and time series database.
...
* [Data Profiler](https://github.com/capitalone/dataprofiler) ⭐ 1,582 | 🐛 80 | 🌐 Python | 📅 2026-09-14 - The DataProfiler is a Python library designed to make data analysis, monitoring, and sensitive data detection easy.
* [Desbordante](https://github.com/desbordante/desbordante-core) ⭐ 499 | 🐛 94 | 🌐 C++ | 📅 2026-09-09 - An open-source data profiler specifically focused on discovery and validation of complex patterns in data.
...
* [dbmask](https://github.com/sealandseacat/dbmask) ⭐ 137 | 🐛 3 | 🌐 Python | 📅 2026-09-10 - Open-source tool that scans SQL databases for sensitive columns, masks them with deterministic fakes, and validates the masked copy row by row against the original.
* [daffy](https://github.com/vertti/daffy/) ⭐ 59 | 🐛 2 | 🌐 Python | 📅 2026-09-14 - Decorator-first DataFrame contracts/validation (columns/dtypes/constraints) at function boundaries. Supports Pandas/Polars/PyArrow/Modin.
...
* [Provero](https://github.com/provero-org/provero) ⭐ 17 | 🐛 12 | 🌐 Python | 📅 2026-09-07 - A vendor-neutral, declarative data quality engine. Define checks in YAML, run anywhere. Includes 16 built-in check types, SQL batch optimizer, anomaly detection, and data contracts.
