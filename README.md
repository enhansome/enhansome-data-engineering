...
* Relational
  * [RQLite](https://github.com/rqlite/rqlite) ⭐ 17,756 | 🐛 74 | 🌐 Go | 📅 2026-09-22 - Replicated SQLite using the Raft consensus protocol.
  * [MySQL](https://www.mysql.com/) - The world's most popular open source database.
    * [TiDB](https://github.com/pingcap/tidb) ⭐ 40,572 | 🐛 7,108 | 🌐 Go | 📅 2026-09-23 - A distributed NewSQL database compatible with MySQL protocol.
...
* Column
  * [FiloDB](https://github.com/filodb/FiloDB) ⭐ 1,467 | 🐛 68 | 🌐 Scala | 📅 2026-09-21 - Distributed. Columnar. Versioned. Streaming. SQL.
  * [Cassandra](https://cassandra.apache.org/) - The right choice when you need scalability and high availability without compromising performance.
    * [ScyllaDB](https://github.com/scylladb/scylla) ⭐ 15,772 | 🐛 3,683 | 🌐 C++ | 📅 2026-09-22 - NoSQL data store using the seastar framework, compatible with Apache Cassandra.
...
* Graph
  ...
  * [Omnigraph](https://github.com/ModernRelay/omnigraph) ⭐ 1,191 | 🐛 67 | 🌐 Rust | 📅 2026-09-22 - Typed graph database where agents branch and merge like Git. S3-native, Rust, traversal + vector + BM25 in one runtime.
...
* Timeseries
  * [InfluxDB](https://github.com/influxdata/influxdb) ⭐ 31,754 | 🐛 2,183 | 🌐 Rust | 📅 2026-09-22 - Scalable datastore for metrics, events, and real-time analytics.
  * [Druid](https://github.com/apache/incubator-druid) ⭐ 14,056 | 🐛 785 | 🌐 Java | 📅 2026-09-23 - Column oriented distributed data store ideal for powering interactive applications.
...
* Other
  ...
  * [Manticore Search](https://github.com/manticoresoftware/manticoresearch) ⭐ 12,030 | 🐛 647 | 🌐 C++ | 📅 2026-09-22 - An open-source search database for full-text, vector, and hybrid search with real-time indexing and SQL.
  * [Tarantool](https://github.com/tarantool/tarantool/) ⭐ 3,667 | 🐛 1,727 | 🌐 Lua | 📅 2026-09-22 - An in-memory database and application server.
  ...
  * [ReductStore](https://github.com/reductstore/reductstore) ⭐ 371 | 🐛 11 | 🌐 Rust | 📅 2026-09-22 - High-performance blob and time-series storage, with edge deployment, selective replication, and efficient querying of multimodal data.
...
* [datacompy](https://github.com/capitalone/datacompy) ⭐ 659 | 🐛 9 | 🌐 Python | 📅 2026-09-21 - A Python library that facilitates the comparison of two DataFrames in Pandas, Polars, Spark and more. The library goes beyond basic equality checks by providing detailed insights into discrepancies at both row and column levels.
* [dvt](https://github.com/GoogleCloudPlatform/professional-services-data-validator) ⭐ 525 | 🐛 153 | 🌐 Python | 📅 2026-09-22 - Data Validation Tool compares data from source and target tables to ensure that they match. It provides column validation, row validation, schema validation, custom query validation, and ad hoc SQL exploration.
...
* [Kreuzberg](https://github.com/kreuzberg-dev/kreuzberg) ⭐ 9,334 | 🐛 2 | 🌐 Rust | 📅 2026-09-22 - Polyglot document intelligence library with a Rust core and bindings for Python, TypeScript, Go, and more. Extracts text, tables, and metadata from 62+ document formats for data pipeline ingestion.
* [Jitsu](https://github.com/jitsucom/jitsu) ⭐ 5,088 | 🐛 46 | 🌐 TypeScript | 📅 2026-09-22 - An open-source Customer Data Platform. Captures event data from websites, apps, and servers and streams it into ClickHouse, Snowflake, BigQuery, Redshift, Postgres, and MySQL in real time.
* [AWS Data Wrangler](https://github.com/awslabs/aws-data-wrangler) ⭐ 4,119 | 🐛 57 | 🌐 Python | 📅 2026-09-22 - Utility belt to handle data on AWS.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,971 | 🐛 21 | 🌐 Go | 📅 2026-09-22 - CLI tool to copy data between databases with a single command. Supports 50+ sources including PostgreSQL, MySQL, MongoDB, Salesforce, Shopify to any data warehouse.
* [Heka](https://github.com/mozilla-services/heka) ⚠️ Archived - Data Acquisition and Processing Made Easy. Deprecated.
* [Gobblin](https://github.com/apache/incubator-gobblin) ⭐ 2,271 | 🐛 143 | 🌐 Java | 📅 2026-07-31 - Universal data ingestion framework for Hadoop from LinkedIn.
* [Duckle](https://github.com/SouravRoy-ETL/duckle) ⭐ 1,314 | 🐛 62 | 🌐 Rust | 📅 2026-09-22 - Local-first, open-source desktop ETL/ELT studio: drag a pipeline onto a canvas (or describe it to a built-in on-device AI assistant) and run it at native speed through DuckDB. 290+ connectors, a scheduler, and an MCP server for driving pipelines from an LLM. No cloud, no servers.
...
* [drt](https://github.com/drt-hub/drt) ⭐ 32 | 🐛 43 | 🌐 Python | 📅 2026-09-22 - OSS Reverse ETL CLI. Sync data from warehouses to business tools via YAML.
...
* [faucet-stream](https://github.com/PawanSikawat/faucet-stream) ⭐ 12 | 🐛 14 | 🌐 Rust | 📅 2026-09-22 - Config-driven data-movement platform for Rust with pluggable source and sink connectors, running ETL, CDC, and streaming pipelines declaratively from YAML or embedded as a library.
...
* [crdt-merge](https://github.com/mgillr/crdt-merge) ⭐ 7 | 🐛 6 | 🌐 Python | 📅 2026-09-19 - Conflict-free merge for DataFrames, JSON, ML models & distributed agents — powered by CRDTs.
...
* [Kafka](https://kafka.apache.org/) - Publish-subscribe messaging rethought as a distributed commit log.
  ...
  * [Secor](https://github.com/pinterest/secor) ⭐ 1,858 | 🐛 270 | 🌐 Java | 📅 2026-03-10 - Pinterest's Kafka to S3 distributed consumer.
  * [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 1,055 | 🐛 594 | 🌐 C | 📅 2026-09-22 - The Apache Kafka C/C++ library.
  * [kafkat](https://github.com/airbnb/kafkat) ⭐ 502 | 🐛 14 | 🌐 Ruby | 📅 2019-06-01 - Simplified command-line administration for Kafka brokers.
  * [Kroxylicious](https://github.com/kroxylicious/kroxylicious) ⭐ 323 | 🐛 375 | 🌐 Java | 📅 2026-09-22 - A Kafka Proxy, solving problems like encrypting your Kafka data at rest.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 14,454 | 🐛 210 | 🌐 Go | 📅 2026-09-22 - A high-performance Cloud-Native file system driven by object storage for large-scale data storage.
* [S3QL](https://github.com/s3ql/s3ql/) ⭐ 1,275 | 🐛 11 | 🌐 Python | 📅 2026-09-19 - A file system that stores all its data online using storage services like Google Storage, Amazon S3, or OpenStack.
...
* [AWS S3](https://aws.amazon.com/s3/) - Object storage built to retrieve any amount of data from anywhere.
  * [smart\_open](https://github.com/RaRe-Technologies/smart_open) ⭐ 3,459 | 🐛 3 | 🌐 Python | 📅 2026-09-05 - Utils for streaming large files (S3, HDFS, gzip, bz2).
...
* [ProtoBuf](https://github.com/protocolbuffers/protobuf) ⭐ 72,056 | 🐛 494 | 🌐 C++ | 📅 2026-09-23 - Protocol Buffers - Google's data interchange format.
* [Kryo](https://github.com/EsotericSoftware/kryo) ⭐ 6,544 | 🐛 33 | 🌐 HTML | 📅 2026-09-21 - A fast and efficient object graph serialization framework for Java.
...
* [Apache Parquet](https://parquet.apache.org) - A columnar storage format available to any project in the Hadoop ecosystem, regardless of the choice of data processing framework, data model or programming language.
  * [Snappy](https://github.com/google/snappy) ⭐ 6,614 | 🐛 66 | 🌐 C++ | 📅 2026-09-18 - A fast compressor/decompressor. Used with Parquet.
...
* [Pathway](https://github.com/pathwaycom/pathway) ⭐ 62,246 | 🐛 37 | 🌐 Python | 📅 2026-09-22 - Performant open-source Python ETL framework with Rust runtime, supporting 300+ data sources.
* [CocoIndex](https://github.com/cocoindex-io/cocoindex) ⭐ 11,591 | 🐛 85 | 🌐 Rust | 📅 2026-09-22 - An open source ETL framework to build fresh index for AI.
...
* [Kuiper](https://github.com/emqx/kuiper) ⭐ 1,736 | 🐛 54 | 🌐 Go | 📅 2026-09-22 - An edge lightweight IoT data analytics/streaming software implemented by Golang, and it can be run at all kinds of resource-constrained edge devices.
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,720 | 🐛 277 | 🌐 Java | 📅 2026-09-23 - - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT, and the native Kafka protocol.
...
* [Apache Superset](https://github.com/apache/incubator-superset) ⭐ 74,887 | 🐛 562 | 🌐 Python | 📅 2026-09-23 - A modern, enterprise-ready business intelligence web application.
* [Metabase](https://github.com/metabase/metabase) ⭐ 49,375 | 🐛 4,448 | 🌐 Clojure | 📅 2026-09-23 - The easy, open source way for everyone in your company to ask questions and learn from data.
* [Plotly](https://github.com/plotly/dash) ⭐ 24,424 | 🐛 432 | 🌐 Python | 📅 2026-09-22 - Flask, JS, and CSS boilerplate for interactive, web-based visualization apps in Python.
* [PyXley](https://github.com/stitchfix/pyxley) ⚠️ Archived - Python helpers for building dashboards using Flask and React.
* [Dekart](https://github.com/dekart-xyz/dekart) ⭐ 420 | 🐛 33 | 🌐 JavaScript | 📅 2026-09-22 - Open-source SQL to map platform for BigQuery, Snowflake, and PostGIS.
...
* [FlexViz](https://github.com/flex-analytics/flexviz) ⭐ 34 | 🐛 19 | 🌐 Python | 📅 2026-09-22 - Open-source Python library for interactive cross-filter dashboards on large datasets. Zoom, pan, and selection are answered by lazy Polars aggregations on a stateless server instead of sending rows to the browser.
...
* [Airflow](https://github.com/apache/airflow) ⭐ 46,950 | 🐛 2,109 | 🌐 Python | 📅 2026-09-22 - A system to programmatically author, schedule, and monitor data pipelines.
* [Kestra](https://github.com/kestra-io/kestra) ⭐ 28,265 | 🐛 685 | 🌐 Java | 📅 2026-09-22 - Scalable, event-driven, language-agnostic orchestration and scheduling platform to manage millions of workflows declaratively in code.
* [Luigi](https://github.com/spotify/luigi) ⭐ 18,777 | 🐛 177 | 🌐 Python | 📅 2026-07-18 - A Python module that helps you build complex pipelines of batch jobs.
* [Dagster](https://github.com/dagster-io/dagster) ⭐ 16,193 | 🐛 2,564 | 🌐 Python | 📅 2026-09-22 - An open-source Python library for building data applications.
* [DataFlow](https://github.com/OpenDCAI/DataFlow) ⭐ 8,196 | 🐛 10 | 🌐 Python | 📅 2026-09-20 - Open-source platform for data preparation, synthetic data generation, and AI/data pipelines. Includes reusable skills for automating workflow steps across data and AI tasks.
* [RudderStack](https://github.com/rudderlabs/rudder-server) ⭐ 4,488 | 🐛 49 | 🌐 Go | 📅 2026-09-22 - A warehouse-first Customer Data Platform that enables you to collect data from every application, website and SaaS platform, and then activate it in your warehouse and business tools.
* [Hamilton](https://github.com/dagworks-inc/hamilton) ⭐ 2,597 | 🐛 177 | 🌐 Jupyter Notebook | 📅 2026-09-20 - A lightweight library to define data transformations as a directed-acyclic graph (DAG). If you like dbt for SQL transforms, you will like Hamilton for Python processing.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,711 | 🐛 63 | 🌐 Go | 📅 2026-09-22 - End-to-end data pipeline tool that combines ingestion, transformation (SQL + Python), and data quality in a single CLI. Connects to BigQuery, Snowflake, PostgreSQL, Redshift, and more. Includes VS Code extension with live previews.
* [Multiwoven](https://github.com/Multiwoven/multiwoven) ⭐ 1,675 | 🐛 194 | 🌐 Ruby | 📅 2026-09-23 - The open-source reverse ETL, data activation platform for modern data teams.
...
* [OrionBelt Semantic Layer](https://github.com/ralfbecher/orionbelt-semantic-layer) ⭐ 97 | 🐛 0 | 🌐 Python | 📅 2026-09-22 - Open-source semantic sidecar that compiles YAML-defined dimensions, measures, and metrics into optimized SQL across 8 engines (BigQuery, ClickHouse, Databricks, Dremio, DuckDB, MySQL, PostgreSQL, Snowflake). Unified REST, MCP, and Postgres wire protocol; one model powers AI agents, analytics, DQ rules, and KPIs.
* [Nika](https://github.com/supernovae-st/nika) ⭐ 89 | 🐛 142 | 🌐 Rust | 📅 2026-09-22 - Intent-as-code workflow engine for AI data pipelines: reviewable YAML DAGs statically checked (schema, permits, cost floor) before execution, with tamper-evident run traces.
* [PACE](https://github.com/getstrm/pace) ⭐ 40 | 🐛 16 | 🌐 Kotlin | 📅 2026-09-21 - An open source framework that allows you to enforce agreements on how data should be accessed, used, and transformed, regardless of the data platform (Snowflake, BigQuery, DataBricks, etc.)
...
* [lakeFS](https://github.com/treeverse/lakeFS) ⭐ 5,538 | 🐛 445 | 🌐 Go | 📅 2026-09-22 - An open source platform that delivers resilience and manageability to object-storage based data lakes.
* [Gravitino](https://github.com/apache/gravitino) ⭐ 3,238 | 🐛 1,109 | 🌐 Java | 📅 2026-09-22 - An open-source, unified metadata management for data lakes, data warehouses, and external catalogs.
* [Project Nessie](https://github.com/projectnessie/nessie) ⭐ 1,514 | 🐛 166 | 🌐 Java | 📅 2026-09-22 - A Transactional Catalog for Data Lakes with Git-like semantics. Works with Apache Iceberg tables.
...
* [cAdvisor](https://github.com/google/cadvisor) ⭐ 19,439 | 🐛 65 | 🌐 Go | 📅 2026-09-18 - Analyzes resource usage and performance characteristics of running containers.
* [Nomad](https://github.com/hashicorp/nomad) ⭐ 16,964 | 🐛 1,628 | 🌐 Go | 📅 2026-09-22 - A cluster manager, designed for both long-lived services and short-lived batch processing workloads.
...
* [Prometheus.io](https://github.com/prometheus/prometheus) ⭐ 66,178 | 🐛 911 | 🌐 Go | 📅 2026-09-22 - An open-source service monitoring system and time series database.
...
* [Desbordante](https://github.com/desbordante/desbordante-core) ⭐ 506 | 🐛 90 | 🌐 C++ | 📅 2026-09-21 - An open-source data profiler specifically focused on discovery and validation of complex patterns in data.
...
* [dbmask](https://github.com/sealandseacat/dbmask) ⭐ 148 | 🐛 2 | 🌐 Python | 📅 2026-09-20 - Open-source tool that scans SQL databases for sensitive columns, masks them with deterministic fakes, and validates the masked copy row by row against the original.
* [daffy](https://github.com/vertti/daffy/) ⭐ 59 | 🐛 2 | 🌐 Python | 📅 2026-09-22 - Decorator-first DataFrame contracts/validation (columns/dtypes/constraints) at function boundaries. Supports Pandas/Polars/PyArrow/Modin.
...
* [Provero](https://github.com/provero-org/provero) ⭐ 17 | 🐛 11 | 🌐 Python | 📅 2026-09-21 - A vendor-neutral, declarative data quality engine. Define checks in YAML, run anywhere. Includes 16 built-in check types, SQL batch optimizer, anomaly detection, and data contracts.
* [Scherlok](https://github.com/rbmuller/scherlok) ⭐ 9 | 🐛 15 | 🌐 Python | 📅 2026-09-22 - Zero-config data quality CLI. Profiles every table on first run, then auto-detects anomalies (volume drops, schema drift, freshness misses, distribution shifts) on subsequent runs. No YAML, no rules to write. Works with Postgres, BigQuery, Snowflake, and dbt.
