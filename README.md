...
* Relational
  * [RQLite](https://github.com/rqlite/rqlite) ⭐ 17,693 | 🐛 82 | 🌐 Go | 📅 2026-08-20 - Replicated SQLite using the Raft consensus protocol.
  * [MySQL](https://www.mysql.com/) - The world's most popular open source database.
    * [TiDB](https://github.com/pingcap/tidb) ⭐ 40,456 | 🐛 6,825 | 🌐 Go | 📅 2026-08-20 - A distributed NewSQL database compatible with MySQL protocol.
...
* Column
  ...
  * [Cassandra](https://cassandra.apache.org/) - The right choice when you need scalability and high availability without compromising performance.
    * [ScyllaDB](https://github.com/scylladb/scylla) ⭐ 15,718 | 🐛 3,568 | 🌐 C++ | 📅 2026-08-20 - NoSQL data store using the seastar framework, compatible with Apache Cassandra.
...
* Graph
  ...
  * [Omnigraph](https://github.com/ModernRelay/omnigraph) ⭐ 1,071 | 🐛 29 | 🌐 Rust | 📅 2026-08-20 - Typed graph database where agents branch and merge like Git. S3-native, Rust, traversal + vector + BM25 in one runtime.
...
* Timeseries
  * [InfluxDB](https://github.com/influxdata/influxdb) ⭐ 31,706 | 🐛 2,147 | 🌐 Rust | 📅 2026-08-20 - Scalable datastore for metrics, events, and real-time analytics.
  * [Druid](https://github.com/apache/incubator-druid) ⭐ 14,044 | 🐛 803 | 🌐 Java | 📅 2026-08-20 - Column oriented distributed data store ideal for powering interactive applications.
...
* Other
  * [zvec](https://github.com/alibaba/zvec) ⭐ 15,488 | 🐛 59 | 🌐 C++ | 📅 2026-08-20 - An embedded vector database for on-device RAG and edge AI, the SQLite of vector databases.
  * [cayley](https://github.com/cayleygraph/cayley) ⭐ 15,060 | 🐛 93 | 🌐 Go | 📅 2026-08-17 - An open-source graph database. Google.
  * [Tarantool](https://github.com/tarantool/tarantool/) ⭐ 3,664 | 🐛 1,696 | 🌐 Lua | 📅 2026-08-20 - An in-memory database and application server.
...
* [dvt](https://github.com/GoogleCloudPlatform/professional-services-data-validator) ⭐ 520 | 🐛 147 | 🌐 Python | 📅 2026-08-20 - Data Validation Tool compares data from source and target tables to ensure that they match. It provides column validation, row validation, schema validation, custom query validation, and ad hoc SQL exploration.
...
* [Kreuzberg](https://github.com/kreuzberg-dev/kreuzberg) ⭐ 9,181 | 🐛 15 | 🌐 Rust | 📅 2026-08-20 - Polyglot document intelligence library with a Rust core and bindings for Python, TypeScript, Go, and more. Extracts text, tables, and metadata from 62+ document formats for data pipeline ingestion.
...
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,850 | 🐛 16 | 🌐 Go | 📅 2026-08-19 - CLI tool to copy data between databases with a single command. Supports 50+ sources including PostgreSQL, MySQL, MongoDB, Salesforce, Shopify to any data warehouse.
...
* [Duckle](https://github.com/SouravRoy-ETL/duckle) ⭐ 1,174 | 🐛 61 | 🌐 Rust | 📅 2026-08-20 - Local-first, open-source desktop ETL/ELT studio: drag a pipeline onto a canvas (or describe it to a built-in on-device AI assistant) and run it at native speed through DuckDB. 290+ connectors, a scheduler, and an MCP server for driving pipelines from an LLM. No cloud, no servers.
...
* [drt](https://github.com/drt-hub/drt) ⭐ 29 | 🐛 57 | 🌐 Python | 📅 2026-08-20 - OSS Reverse ETL CLI. Sync data from warehouses to business tools via YAML.
...
* [faucet-stream](https://github.com/PawanSikawat/faucet-stream) ⭐ 8 | 🐛 13 | 🌐 Rust | 📅 2026-08-20 - Config-driven data-movement platform for Rust with pluggable source and sink connectors, running ETL, CDC, and streaming pipelines declaratively from YAML or embedded as a library.
...
* [Kafka](https://kafka.apache.org/) - Publish-subscribe messaging rethought as a distributed commit log.
  ...
  * [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 1,035 | 🐛 593 | 🌐 C | 📅 2026-08-20 - The Apache Kafka C/C++ library.
  * [kafkat](https://github.com/airbnb/kafkat) ⭐ 502 | 🐛 14 | 🌐 Ruby | 📅 2019-06-01 - Simplified command-line administration for Kafka brokers.
  * [Kroxylicious](https://github.com/kroxylicious/kroxylicious) ⭐ 312 | 🐛 384 | 🌐 Java | 📅 2026-08-20 - A Kafka Proxy, solving problems like encrypting your Kafka data at rest.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 14,346 | 🐛 200 | 🌐 Go | 📅 2026-08-20 - A high-performance Cloud-Native file system driven by object storage for large-scale data storage.
...
* [ProtoBuf](https://github.com/protocolbuffers/protobuf) ⭐ 71,748 | 🐛 316 | 🌐 C++ | 📅 2026-08-20 - Protocol Buffers - Google's data interchange format.
* [Kryo](https://github.com/EsotericSoftware/kryo) ⭐ 6,545 | 🐛 28 | 🌐 HTML | 📅 2026-08-20 - A fast and efficient object graph serialization framework for Java.
...
* [Pathway](https://github.com/pathwaycom/pathway) ⭐ 62,412 | 🐛 35 | 🌐 Python | 📅 2026-08-20 - Performant open-source Python ETL framework with Rust runtime, supporting 300+ data sources.
* [CocoIndex](https://github.com/cocoindex-io/cocoindex) ⭐ 11,372 | 🐛 71 | 🌐 Rust | 📅 2026-08-18 - An open source ETL framework to build fresh index for AI.
* [PipelineDB](https://github.com/pipelinedb/pipelinedb) ⭐ 2,662 | 🐛 133 | 🌐 C | 📅 2022-02-20 - The Streaming SQL Database.
* [Robinhood's Faust](https://github.com/faust-streaming/faust) ⭐ 1,884 | 🐛 149 | 🌐 Python | 📅 2026-08-20 - Forever scalable event processing & in-memory durable K/V store as a library with asyncio & static typing.
* [Kuiper](https://github.com/emqx/kuiper) ⭐ 1,729 | 🐛 49 | 🌐 Go | 📅 2026-08-19 - An edge lightweight IoT data analytics/streaming software implemented by Golang, and it can be run at all kinds of resource-constrained edge devices.
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,687 | 🐛 219 | 🌐 Java | 📅 2026-08-20 - - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT, and the native Kafka protocol.
...
* [Apache Superset](https://github.com/apache/incubator-superset) ⭐ 74,325 | 🐛 614 | 🌐 Python | 📅 2026-08-20 - A modern, enterprise-ready business intelligence web application.
* [Metabase](https://github.com/metabase/metabase) ⭐ 48,854 | 🐛 4,377 | 🌐 Clojure | 📅 2026-08-20 - The easy, open source way for everyone in your company to ask questions and learn from data.
* [Plotly](https://github.com/plotly/dash) ⭐ 24,378 | 🐛 539 | 🌐 Python | 📅 2026-08-20 - Flask, JS, and CSS boilerplate for interactive, web-based visualization apps in Python.
...
* [Airflow](https://github.com/apache/airflow) ⭐ 46,561 | 🐛 1,892 | 🌐 Python | 📅 2026-08-20 - A system to programmatically author, schedule, and monitor data pipelines.
* [Kestra](https://github.com/kestra-io/kestra) ⭐ 27,867 | 🐛 558 | 🌐 Java | 📅 2026-08-20 - Scalable, event-driven, language-agnostic orchestration and scheduling platform to manage millions of workflows declaratively in code.
...
* [Dagster](https://github.com/dagster-io/dagster) ⭐ 16,037 | 🐛 2,595 | 🌐 Python | 📅 2026-08-20 - An open-source Python library for building data applications.
* [DataFlow](https://github.com/OpenDCAI/DataFlow) ⭐ 7,613 | 🐛 8 | 🌐 Python | 📅 2026-08-18 - Open-source platform for data preparation, synthetic data generation, and AI/data pipelines. Includes reusable skills for automating workflow steps across data and AI tasks.
* [RudderStack](https://github.com/rudderlabs/rudder-server) ⭐ 4,475 | 🐛 51 | 🌐 Go | 📅 2026-08-20 - A warehouse-first Customer Data Platform that enables you to collect data from every application, website and SaaS platform, and then activate it in your warehouse and business tools.
* [Hamilton](https://github.com/dagworks-inc/hamilton) ⭐ 2,571 | 🐛 153 | 🌐 Jupyter Notebook | 📅 2026-08-19 - A lightweight library to define data transformations as a directed-acyclic graph (DAG). If you like dbt for SQL transforms, you will like Hamilton for Python processing.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,671 | 🐛 32 | 🌐 Go | 📅 2026-08-20 - End-to-end data pipeline tool that combines ingestion, transformation (SQL + Python), and data quality in a single CLI. Connects to BigQuery, Snowflake, PostgreSQL, Redshift, and more. Includes VS Code extension with live previews.
...
* [OrionBelt Semantic Layer](https://github.com/ralfbecher/orionbelt-semantic-layer) ⭐ 72 | 🐛 2 | 🌐 Python | 📅 2026-08-20 - Open-source semantic sidecar that compiles YAML-defined dimensions, measures, and metrics into optimized SQL across 8 engines (BigQuery, ClickHouse, Databricks, Dremio, DuckDB, MySQL, PostgreSQL, Snowflake). Unified REST, MCP, and Postgres wire protocol; one model powers AI agents, analytics, DQ rules, and KPIs.
* [Nika](https://github.com/supernovae-st/nika) ⭐ 54 | 🐛 57 | 🌐 Rust | 📅 2026-08-20 - Intent-as-code workflow engine for AI data pipelines: reviewable YAML DAGs statically checked (schema, permits, cost floor) before execution, with tamper-evident run traces.
...
* [lakeFS](https://github.com/treeverse/lakeFS) ⭐ 5,490 | 🐛 439 | 🌐 Go | 📅 2026-08-19 - An open source platform that delivers resilience and manageability to object-storage based data lakes.
* [Gravitino](https://github.com/apache/gravitino) ⭐ 3,187 | 🐛 1,063 | 🌐 Java | 📅 2026-08-20 - An open-source, unified metadata management for data lakes, data warehouses, and external catalogs.
* [Project Nessie](https://github.com/projectnessie/nessie) ⭐ 1,496 | 🐛 162 | 🌐 Java | 📅 2026-08-20 - A Transactional Catalog for Data Lakes with Git-like semantics. Works with Apache Iceberg tables.
...
* [cAdvisor](https://github.com/google/cadvisor) ⭐ 19,375 | 🐛 65 | 🌐 Go | 📅 2026-07-20 - Analyzes resource usage and performance characteristics of running containers.
* [Nomad](https://github.com/hashicorp/nomad) ⭐ 16,817 | 🐛 1,633 | 🌐 Go | 📅 2026-08-20 - A cluster manager, designed for both long-lived services and short-lived batch processing workloads.
...
* [FirstData](https://github.com/MLT-OSS/FirstData) ⭐ 180 | 🐛 1 | 🌐 Python | 📅 2026-08-17 - The world's most comprehensive authoritative data source knowledge base. 160+ curated sources from governments, international organizations, and research institutions with MCP integration.
...
* [Prometheus.io](https://github.com/prometheus/prometheus) ⭐ 65,765 | 🐛 891 | 🌐 Go | 📅 2026-08-20 - An open-source service monitoring system and time series database.
...
* [Desbordante](https://github.com/desbordante/desbordante-core) ⭐ 498 | 🐛 90 | 🌐 C++ | 📅 2026-08-18 - An open-source data profiler specifically focused on discovery and validation of complex patterns in data.
...
* [daffy](https://github.com/vertti/daffy/) ⭐ 58 | 🐛 5 | 🌐 Python | 📅 2026-08-20 - Decorator-first DataFrame contracts/validation (columns/dtypes/constraints) at function boundaries. Supports Pandas/Polars/PyArrow/Modin.
