...
* Relational
  * [RQLite](https://github.com/rqlite/rqlite) ⭐ 17,751 | 🐛 76 | 🌐 Go | 📅 2026-09-22 - Replicated SQLite using the Raft consensus protocol.
  * [MySQL](https://www.mysql.com/) - The world's most popular open source database.
    * [TiDB](https://github.com/pingcap/tidb) ⭐ 40,566 | 🐛 7,095 | 🌐 Go | 📅 2026-09-22 - A distributed NewSQL database compatible with MySQL protocol.
...
* Column
  ...
  * [Cassandra](https://cassandra.apache.org/) - The right choice when you need scalability and high availability without compromising performance.
    * [ScyllaDB](https://github.com/scylladb/scylla) ⭐ 15,772 | 🐛 3,674 | 🌐 C++ | 📅 2026-09-22 - NoSQL data store using the seastar framework, compatible with Apache Cassandra.
...
* Graph
  ...
  * [Omnigraph](https://github.com/ModernRelay/omnigraph) ⭐ 1,168 | 🐛 67 | 🌐 Rust | 📅 2026-09-21 - Typed graph database where agents branch and merge like Git. S3-native, Rust, traversal + vector + BM25 in one runtime.
...
* Timeseries
  * [InfluxDB](https://github.com/influxdata/influxdb) ⭐ 31,753 | 🐛 2,193 | 🌐 Rust | 📅 2026-09-21 - Scalable datastore for metrics, events, and real-time analytics.
  * [Druid](https://github.com/apache/incubator-druid) ⭐ 14,054 | 🐛 785 | 🌐 Java | 📅 2026-09-22 - Column oriented distributed data store ideal for powering interactive applications.
...
* Other
  ...
  * [Manticore Search](https://github.com/manticoresoftware/manticoresearch) ⭐ 12,028 | 🐛 652 | 🌐 C++ | 📅 2026-09-21 - An open-source search database for full-text, vector, and hybrid search with real-time indexing and SQL.
  * [Tarantool](https://github.com/tarantool/tarantool/) ⭐ 3,668 | 🐛 1,728 | 🌐 Lua | 📅 2026-09-21 - An in-memory database and application server.
...
* [datacompy](https://github.com/capitalone/datacompy) ⭐ 658 | 🐛 7 | 🌐 Python | 📅 2026-09-21 - A Python library that facilitates the comparison of two DataFrames in Pandas, Polars, Spark and more. The library goes beyond basic equality checks by providing detailed insights into discrepancies at both row and column levels.
* [dvt](https://github.com/GoogleCloudPlatform/professional-services-data-validator) ⭐ 525 | 🐛 152 | 🌐 Python | 📅 2026-09-21 - Data Validation Tool compares data from source and target tables to ensure that they match. It provides column validation, row validation, schema validation, custom query validation, and ad hoc SQL exploration.
...
* [Kreuzberg](https://github.com/kreuzberg-dev/kreuzberg) ⭐ 9,332 | 🐛 24 | 🌐 Rust | 📅 2026-09-21 - Polyglot document intelligence library with a Rust core and bindings for Python, TypeScript, Go, and more. Extracts text, tables, and metadata from 62+ document formats for data pipeline ingestion.
* [Jitsu](https://github.com/jitsucom/jitsu) ⭐ 5,087 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-21 - An open-source Customer Data Platform. Captures event data from websites, apps, and servers and streams it into ClickHouse, Snowflake, BigQuery, Redshift, Postgres, and MySQL in real time.
...
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,970 | 🐛 22 | 🌐 Go | 📅 2026-09-21 - CLI tool to copy data between databases with a single command. Supports 50+ sources including PostgreSQL, MySQL, MongoDB, Salesforce, Shopify to any data warehouse.
...
* [Duckle](https://github.com/SouravRoy-ETL/duckle) ⭐ 1,313 | 🐛 60 | 🌐 Rust | 📅 2026-09-21 - Local-first, open-source desktop ETL/ELT studio: drag a pipeline onto a canvas (or describe it to a built-in on-device AI assistant) and run it at native speed through DuckDB. 290+ connectors, a scheduler, and an MCP server for driving pipelines from an LLM. No cloud, no servers.
...
* [faucet-stream](https://github.com/PawanSikawat/faucet-stream) ⭐ 12 | 🐛 18 | 🌐 Rust | 📅 2026-09-21 - Config-driven data-movement platform for Rust with pluggable source and sink connectors, running ETL, CDC, and streaming pipelines declaratively from YAML or embedded as a library.
...
* [Kafka](https://kafka.apache.org/) - Publish-subscribe messaging rethought as a distributed commit log.
  ...
  * [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 1,051 | 🐛 595 | 🌐 C | 📅 2026-09-21 - The Apache Kafka C/C++ library.
  * [kafkat](https://github.com/airbnb/kafkat) ⭐ 502 | 🐛 14 | 🌐 Ruby | 📅 2019-06-01 - Simplified command-line administration for Kafka brokers.
  * [Kroxylicious](https://github.com/kroxylicious/kroxylicious) ⭐ 323 | 🐛 377 | 🌐 Java | 📅 2026-09-21 - A Kafka Proxy, solving problems like encrypting your Kafka data at rest.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 14,448 | 🐛 209 | 🌐 Go | 📅 2026-09-21 - A high-performance Cloud-Native file system driven by object storage for large-scale data storage.
...
* [ProtoBuf](https://github.com/protocolbuffers/protobuf) ⭐ 72,058 | 🐛 480 | 🌐 C++ | 📅 2026-09-22 - Protocol Buffers - Google's data interchange format.
...
* [Pathway](https://github.com/pathwaycom/pathway) ⭐ 62,253 | 🐛 37 | 🌐 Python | 📅 2026-09-21 - Performant open-source Python ETL framework with Rust runtime, supporting 300+ data sources.
* [CocoIndex](https://github.com/cocoindex-io/cocoindex) ⭐ 11,585 | 🐛 87 | 🌐 Rust | 📅 2026-09-21 - An open source ETL framework to build fresh index for AI.
...
* [Kuiper](https://github.com/emqx/kuiper) ⭐ 1,736 | 🐛 53 | 🌐 Go | 📅 2026-09-22 - An edge lightweight IoT data analytics/streaming software implemented by Golang, and it can be run at all kinds of resource-constrained edge devices.
...
* [Apache Superset](https://github.com/apache/incubator-superset) ⭐ 74,873 | 🐛 609 | 🌐 Python | 📅 2026-09-22 - A modern, enterprise-ready business intelligence web application.
* [Metabase](https://github.com/metabase/metabase) ⭐ 49,362 | 🐛 4,416 | 🌐 Clojure | 📅 2026-09-21 - The easy, open source way for everyone in your company to ask questions and learn from data.
* [Plotly](https://github.com/plotly/dash) ⭐ 24,423 | 🐛 439 | 🌐 Python | 📅 2026-09-21 - Flask, JS, and CSS boilerplate for interactive, web-based visualization apps in Python.
* [PyXley](https://github.com/stitchfix/pyxley) ⚠️ Archived - Python helpers for building dashboards using Flask and React.
* [Dekart](https://github.com/dekart-xyz/dekart) ⭐ 419 | 🐛 34 | 🌐 JavaScript | 📅 2026-09-21 - Open-source SQL to map platform for BigQuery, Snowflake, and PostGIS.
...
* [FlexViz](https://github.com/flex-analytics/flexviz) ⭐ 25 | 🐛 24 | 🌐 Python | 📅 2026-09-21 - Open-source Python library for interactive cross-filter dashboards on large datasets. Zoom, pan, and selection are answered by lazy Polars aggregations on a stateless server instead of sending rows to the browser.
...
* [Airflow](https://github.com/apache/airflow) ⭐ 46,929 | 🐛 2,119 | 🌐 Python | 📅 2026-09-22 - A system to programmatically author, schedule, and monitor data pipelines.
* [Kestra](https://github.com/kestra-io/kestra) ⭐ 28,208 | 🐛 672 | 🌐 Java | 📅 2026-09-21 - Scalable, event-driven, language-agnostic orchestration and scheduling platform to manage millions of workflows declaratively in code.
...
* [Dagster](https://github.com/dagster-io/dagster) ⭐ 16,192 | 🐛 2,568 | 🌐 Python | 📅 2026-09-21 - An open-source Python library for building data applications.
* [DataFlow](https://github.com/OpenDCAI/DataFlow) ⭐ 8,195 | 🐛 9 | 🌐 Python | 📅 2026-09-20 - Open-source platform for data preparation, synthetic data generation, and AI/data pipelines. Includes reusable skills for automating workflow steps across data and AI tasks.
* [RudderStack](https://github.com/rudderlabs/rudder-server) ⭐ 4,488 | 🐛 50 | 🌐 Go | 📅 2026-09-21 - A warehouse-first Customer Data Platform that enables you to collect data from every application, website and SaaS platform, and then activate it in your warehouse and business tools.
* [Hamilton](https://github.com/dagworks-inc/hamilton) ⭐ 2,595 | 🐛 178 | 🌐 Jupyter Notebook | 📅 2026-09-20 - A lightweight library to define data transformations as a directed-acyclic graph (DAG). If you like dbt for SQL transforms, you will like Hamilton for Python processing.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,710 | 🐛 61 | 🌐 Go | 📅 2026-09-21 - End-to-end data pipeline tool that combines ingestion, transformation (SQL + Python), and data quality in a single CLI. Connects to BigQuery, Snowflake, PostgreSQL, Redshift, and more. Includes VS Code extension with live previews.
* [Multiwoven](https://github.com/Multiwoven/multiwoven) ⭐ 1,675 | 🐛 194 | 🌐 Ruby | 📅 2026-09-22 - The open-source reverse ETL, data activation platform for modern data teams.
...
* [lakeFS](https://github.com/treeverse/lakeFS) ⭐ 5,536 | 🐛 443 | 🌐 Go | 📅 2026-09-17 - An open source platform that delivers resilience and manageability to object-storage based data lakes.
* [Gravitino](https://github.com/apache/gravitino) ⭐ 3,236 | 🐛 1,081 | 🌐 Java | 📅 2026-09-21 - An open-source, unified metadata management for data lakes, data warehouses, and external catalogs.
* [Project Nessie](https://github.com/projectnessie/nessie) ⭐ 1,513 | 🐛 167 | 🌐 Java | 📅 2026-09-21 - A Transactional Catalog for Data Lakes with Git-like semantics. Works with Apache Iceberg tables.
...
* [Nomad](https://github.com/hashicorp/nomad) ⭐ 16,963 | 🐛 1,626 | 🌐 Go | 📅 2026-09-21 - A cluster manager, designed for both long-lived services and short-lived batch processing workloads.
...
* [Prometheus.io](https://github.com/prometheus/prometheus) ⭐ 66,161 | 🐛 922 | 🌐 Go | 📅 2026-09-21 - An open-source service monitoring system and time series database.
...
* [Desbordante](https://github.com/desbordante/desbordante-core) ⭐ 504 | 🐛 89 | 🌐 C++ | 📅 2026-09-21 - An open-source data profiler specifically focused on discovery and validation of complex patterns in data.
